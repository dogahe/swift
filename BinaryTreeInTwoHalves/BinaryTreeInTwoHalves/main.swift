...
let tree = TreeNode(1, nil, TreeNode(2, nil, TreeNode(3, nil, TreeNode(4, nil, TreeNode(5)))))
//TreeNode(5, TreeNode(1, TreeNode(3), nil), TreeNode(6, TreeNode(7), TreeNode(4)))
print(canSplit(tree))
